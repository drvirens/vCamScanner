...
//        _pointH.alpha=0.5;
        ...
        _pointC.backgroundColor=COLOR_EDGE_DOTS;
        _pointD.backgroundColor=COLOR_EDGE_DOTS;
        
        //middle
        _pointE.backgroundColor=COLOR_EDGE_DOTS;
        _pointF.backgroundColor=COLOR_EDGE_DOTS;
        _pointG.backgroundColor=COLOR_EDGE_DOTS;
        _pointH.backgroundColor=COLOR_EDGE_DOTS;
