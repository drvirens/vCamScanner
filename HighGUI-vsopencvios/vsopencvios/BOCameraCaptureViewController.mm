...
- (void)doCropImage {
    if([self.croppedView frameEdited]){
        double scaleFactor =  [self.capturedImageView contentScale];
        
        CGPoint thePtBottomLeft = [self.croppedView coordinatesForPoint:1 withScaleFactor:scaleFactor];
        CGPoint thePtBottomRight = [self.croppedView coordinatesForPoint:2 withScaleFactor:scaleFactor];
        CGPoint thePtTopRight = [self.croppedView coordinatesForPoint:3 withScaleFactor:scaleFactor];
        CGPoint thePtTopLeft = [self.croppedView coordinatesForPoint:4 withScaleFactor:scaleFactor];
