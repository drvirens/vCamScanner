...
/*CCLOG("BIG_PHAT_ERROR "); was first line in below macro*/
#define BIG_PHAT_ERROR(errorCode) {  IN_FILE_ON_LINE; MoSyncErrorExit(errorCode); }
...
#define IN_FILE_ON_LINE VIREN_LOG("in %s @ line %i\n", __FILE__, __LINE__)
...
#define COMMA ,
//viren commented cuz error in value enum #define NUL
#define NULA(a)
#define NULA2(a,b)
