...
void AppDelegate::doIOSApplicationDidLaunchOnConditionMet(void* launchParams) {
  CCLOG("AppDelegate::doIOSApplicationDidLaunchOnConditionMet");
}

int doScanLaunchParams(void* launchParams) {
	CCLOG("AppDelegate::doScanLaunchParams");
}

int AppDelegate::scanLaunchParams(void* launchParams) {
	CCLOG("AppDelegate::scanLaunchParams");
