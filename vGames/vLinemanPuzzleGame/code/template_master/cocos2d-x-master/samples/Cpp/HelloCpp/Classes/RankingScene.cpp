...
bool RankingScene::init() {
    ...
    CCPoint bgAnchorPoint = background->getAnchorPoint();
    CCLOG("bgAnchorPoint.x = %f, bgAnchorPoint.y = %f", bgAnchorPoint.x, bgAnchorPoint.y);
...
//	int textureWidth = background->getContentSize().width;
//	int textureHeight = background->getContentSize().height;
//
//	float scaleValueX=(float)w/textureWidth;
//	float scaleValueY=(float)h/textureHeight;
//	background->setScaleX(scaleValueX);
//	background->setScaleY(scaleValueY);
//
//
//	background->setAnchorPoint(ccp(0,0));
//	int texture_height=background->getTexture()->getContentSize().height;
