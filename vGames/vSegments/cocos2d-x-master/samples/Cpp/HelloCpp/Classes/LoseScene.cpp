...
//  CCString* string = 0;
//  const char* levelMsg = 0;
//  switch(info.level) {
//    case 0: {
//      string = new CCString("Congratulations! You've cleared the 0th level ! :)");
//      break;
//    }
//    case 1: {
//      string = new CCString("Congratulations! You've cleared the 1st level ! :)");
//      break;
//    }
//    case 2: {
//      string = new CCString("Congratulations! You've cleared the 2nd level ! :)");
//      break;
//    }
//    case 3: {
//      string = new CCString("Congratulations! You've cleared the 3rd level ! :)");
//      break;
//    }
//
//    default: {
//      levelMsg = "Congratulations! You cleared the 2nd level! :)";
//      string = CCString::createWithFormat("Congratulations! You cleared the %ith level! :)", info.level);
//      break;
//    }
//    
//  }
    //CCString* string = CCString::createWithFormat("You've made it to %i !", info.level);
  
    CCString* string = CCString::createWithFormat("%i-lined shape", info.level);
    ...
    #ifdef SHOW_GON_LABEL
    scoreboard->addChild(label);
    #endif
    
    float accuracy = info.accuracy / (float)(info.level-2) * 100.f;
    CCString* accuracyString = CCString::createWithFormat("Average Accuracy: %.2f", accuracy);
