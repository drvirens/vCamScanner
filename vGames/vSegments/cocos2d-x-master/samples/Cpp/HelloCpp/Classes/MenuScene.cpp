...
bool MenuScene::init()
{
    ...
    config->setTarget(this, menu_selector(MenuScene::showSettings));
...
void MenuScene::showSettings()
{
  CCTransitionFade* fade = CCTransitionFade::create(0.25f, SettingsScene::create());
  CCDirector::sharedDirector()->replaceScene(fade);
}
