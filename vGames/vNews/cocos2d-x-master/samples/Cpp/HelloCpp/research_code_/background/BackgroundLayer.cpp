...
bool BackgroundLayer::init()
{
    ...
    CCSprite *treesImage1 = CCSprite::create("bing.jpg");
    //treesImage1->setPosition( ccp(size.width/2, size.height/2) );
    CCPoint point(0,0);
  treesImage1->setAnchorPoint(point);
    this->addChild(treesImage1, 0);
...
void BackgroundLayer::update(float dt)
{
    ...
    parallax->updateWithVelocity(ccp(kNormalScrollVelocity, 0), dt);
}

void BackgroundLayer::disableParallax() {
  mAllowParallax = false;
}
