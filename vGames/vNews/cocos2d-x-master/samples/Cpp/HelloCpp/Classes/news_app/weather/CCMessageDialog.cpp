...
bool CCMessageDialog::init()
{
    ...
    do 
    {
      ...
      CCSprite *mBg = CCSprite::create("prompt_dialog.png");
      CCSprite *cancelNormal = CCSprite::create("btn_bg.png");
      CCSprite *cancelHighlight = CCSprite::create("btn_bg_highlight.png");
      CCSprite *OKNormal = CCSprite::create("btn_bg.png");
      CCSprite *OKHighlight = CCSprite::create("btn_bg_highlight.png");
