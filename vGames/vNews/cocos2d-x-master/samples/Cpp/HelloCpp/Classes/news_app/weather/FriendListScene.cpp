...
void FriendListScene::virenDoInit() {
  onAssignCCBMemberVariable(0,0,0);
  onNodeLoaded(0,0);
}
...
{
	this->ShowLoadingIndicator("Loading message");
...
void FriendListScene::onNodeLoaded(CCNode * pNode, CCNodeLoader * pNodeLoader)
{
  ...
  mTableViewFriend = CCTableView::create(this, CCSizeMake(containerSize.width, containerSize.height));
...
//  }
    ...
    CCLabelTTF *lblName = CCLabelTTF::create("UserName", "Arial", 14.0);
      ...
      //idiom :
		CCLabelTTF *lblFriend = CCLabelTTF::create("SomeIdiom", "Arial", 14.0);
...
//    CCSprite *sline = CCSprite::create("line.png");
////viren+
//        //sline->setPreferredSize(CCSizeMake(290, 1));
//        sline->setContentSize(CCSizeMake(290, 1));
//        //viren-
...
//        chatBtn->setTitleForState(CCString::create("chatBtn"),CCControlStateNormal);
//        
...
//        msgBtn->setTitleForState(CCString::create("msgBtn"),CCControlStateNormal);
...
//        formationBtn->setTitleForState(CCString::create("formationBtn"),CCControlStateNormal);
...
//        deleteBtn->setTitleForState(CCString::create("deleteBtn"),CCControlStateNormal);
...
//        cell->addChild(deleteBtn);
    ...
    lblName->setString("New label Name");
    //viren-
