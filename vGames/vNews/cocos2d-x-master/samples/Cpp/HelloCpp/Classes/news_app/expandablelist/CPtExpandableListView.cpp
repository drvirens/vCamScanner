...
//            count += ((CPtExpandableListViewItem *)(m_pExpListViewItems->objectAtIndex(m_nWhichOneOpen)))->getChildren()->count();
          ...
          if (((CPtExpandableListViewItem *)(m_pExpListViewItems->objectAtIndex(m_nWhichOneOpen)))->getChildren() ) {
            count += ((CPtExpandableListViewItem *)(m_pExpListViewItems->objectAtIndex(m_nWhichOneOpen)))->getChildren()->count();
          }
            //viren-
...
CPtExpandableListView::CPtExpandableListView() : selectedindex(-1)
{
    m_cItems = NULL;
}
...
CCSize CPtExpandableListView::tableCellSizeForIndex(CCTableView *table, unsigned int idx)
{
//viren+
