...
//
//  void WebView::callbackFromJS(CCWebView *webview, CCString *message){
...
//  }
//
//  void WebView::showResult(std::string* str1, std::string* str2){
//    CCMessageBox(str1->c_str(), str2->c_str());
//  }


	WebView::WebView()  : mWebViewListener(0), m_webView(0)
//		Widget(MAW_WEB_VIEW)
	{
  CCLOG ( "WebView::WebView" );
  //TODO: move in init
//    mCCWebView = CCWebView::create();
//    mCCWebView->setWebViewDelegate(this);
...
//        mWebViewListeners.clear();
	...
	{
    CCLOG ( "WebView::openURL [ %s ]", url.c_str() );
//		this->setProperty(MAW_WEB_VIEW_URL, url.c_str());

//    mCCWebView->loadUrl(url.c_str());
    ...
    m_webView->showWebView(url.c_str(), 20, 20, 460, 780);
	...
	{
  CCLOG ( "WebView::getURL" );
//		return this->getPropertyString(MAW_WEB_VIEW_URL);
    MAUtil::String currUrl("temp.viren.current.com");
    return currUrl;
	}
...
//		this->setProperty(MAW_WEB_VIEW_BASE_URL, baseUrl);
	...
	{
  CCLOG ( "WebView::getBaseUrl" );
//		return this->getPropertyString(MAW_WEB_VIEW_BASE_URL);
    MAUtil::String baseUrl("base.temp.url.viren.com");
    return baseUrl;
	}
...
//		}
	...
	{
  CCLOG ( "WebView::canNavigateForward" );
//		MAUtil::String value = this->getPropertyString(MAW_WEB_VIEW_NAVIGATE);
...
//		}
	...
	{
  CCLOG ( "WebView::enableHorizontalScrollBar" );
//		this->setProperty(MAW_WEB_VIEW_HORIZONTAL_SCROLL_BAR_ENABLED, "true");
	...
	{
  CCLOG ( "WebView::disableHorizontalScrollbar" );
//		this->setProperty(MAW_WEB_VIEW_HORIZONTAL_SCROLL_BAR_ENABLED, "false");
	...
	{
  CCLOG ( "WebView::isHorizontalScrollbarEnabled" );
...
//        }
	...
	{
  CCLOG ( "WebView::enableVerticalScrollBar" );
//		this->setProperty(MAW_WEB_VIEW_VERTICAL_SCROLL_BAR_ENABLED, "true");
	...
	{
  CCLOG ( "WebView::disableVerticalScrollbar" );
//		this->setProperty(MAW_WEB_VIEW_VERTICAL_SCROLL_BAR_ENABLED, "false");
	...
	{
  CCLOG ( "WebView::isVerticalScrollBarEnabled" );
//        MAUtil::String value = MAUtil::lowerString(
...
//        }
    ...
    {
    CCLOG ( "WebView::getNewURL" );
//        return this->getPropertyString(MAW_WEB_VIEW_NEW_URL);
      MAUtil::String url("viren.temp.url.com");
      return url;
    }
    ...
    {
    CCLOG ( "WebView::addWebViewListener" );
		//addListenerToVector(mWebViewListeners, listener);
      mWebViewListener = listener; //only one for now
      if (m_webView && listener) {
        m_webView->addWebViewListener(listener);
      }
    }
    ...
    {
    CCLOG ( "WebView::removeWebViewListener" );
//		removeListenerFromVector(mWebViewListeners, listener);
	...
	{
  CCLOG ( "WebView::enableWebViewMessages" );
//		maWidgetSetProperty(
//			getWidgetHandle(),
...
//			"mosync://.*");
	...
	{
  CCLOG ( "WebView::disableWebViewMessages" );
//		maWidgetSetProperty(
//			getWidgetHandle(),
//			MAW_WEB_VIEW_HARD_HOOK,
//			"");
