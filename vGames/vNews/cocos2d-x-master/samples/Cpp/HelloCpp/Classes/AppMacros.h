...
//static Resource smallResource  =  { cocos2d::CCSizeMake(320, 480),   "iphone" }; //iPhone 4/4s
static Resource smallResource  =  { cocos2d::CCSizeMake(320, 568),   "iphone" }; //iPhone 5 and above
...
static Resource tizenResource =  { cocos2d::CCSizeMake(720, 1280),  "tizen"   };

#if (TARGET_DESIGN_RESOLUTION_SIZE == DESIGN_RESOLUTION_720X1280)
...
// The font size 24 is designed for small resolution, so we should change it to fit for current design resolution
#define TITLE_FONT_SIZE  (cocos2d::CCEGLView::sharedOpenGLView()->getDesignResolutionSize().width / tizenResource.size.width * 24)
