...
R::LanguageFuncPtr loadEN(Translation& tr)
{
    ...
    tr[AlarmTimeChooser_AlarmIsSet] = "Alarm time: ";
    tr[AlarmTimeChooser_TimeToSleep] = "You'll sleep for: ";
