...
bool MenuScene::init()
{
    ...
    //////////////////////////////
    // 1. super init first
    if ( ! CCLayerGradient::initWithColor(ccc4(113, 152, 210, 255),
                                          ccc4(222, 231, 244, 255), ccp(0, -1)))
//  if ( ! CCLayerGradient::initWithColor(ccc4(202, 180, 74, 255),
//                                        ccc4(134, 114, 4, 255), ccp(0, -1)))
    {
        return false;
    }
