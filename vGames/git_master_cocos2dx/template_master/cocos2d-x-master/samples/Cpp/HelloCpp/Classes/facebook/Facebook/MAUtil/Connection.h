...
public:
  ...
  virtual void write(const void* src, int len);
  
protected:
  void request(CCHttpRequest::HttpRequestType op,
...
protected:
  ...
  std::string mFullUrl;
  CCHttpRequest::HttpRequestType mHttpMethod;
