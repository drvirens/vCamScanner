...
private:
	 ...
	 */
	void removeComment(FacebookDemoApplication::OpenMenuCommand *openMenuCmd, const MAUtil::String &id );

	/*
	 * adds a remove Friendlist command on a button. Adds the button to a menu (the Screen contained in openMenuCmd)
	 */
	void removeFriendList(FacebookDemoApplication::OpenMenuCommand *openMenuCmd, const MAUtil::String &id );

	/*
	 * adds a remove Note command on a button. Adds the button to a menu (the Screen contained in openMenuCmd)
	 */
	void removeNote(FacebookDemoApplication::OpenMenuCommand *openMenuCmd, const MAUtil::String &id );
