...
public:
	 ...
	 */
	RemoveCommand(	FacebookManager *facebookManager,
                  FacebookDemoGUI::FacebookDemoScreen *prevScreen,
					const MAUtil::String &targetObjectID )
...
public:
	RemoveCommand(FacebookManager *facebookManager, FacebookDemoGUI::FacebookDemoScreen *prevScreen,
			const MAUtil::String &targetObjectID ) : PublishCommand(facebookManager, prevScreen)
	{
