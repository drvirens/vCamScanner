...
bool GameOverLayer::init()
{
  ...
  long theCurrentScore = GameManager::sharedGameManager()->getScore();
  long theLastScore = AppDelegate::getCurrentScore();
    if (theLastScore > bestScore )
//        && GameManager::sharedGameManager()->getDistance() > bestDistance)
    {
        //bestScore = GameManager::sharedGameManager()->getScore();
        bestScore = theLastScore;
    ...
    CCString *score = CCString::createWithFormat("YOUR SCORE: %ld", GameManager::sharedGameManager()->getScore());
    ...
    CCString *distance = CCString::createWithFormat("YOUR DISTANCE: %ld", GameManager::sharedGameManager()->getDistance());
...
{
	CCLOG("GameOverLayer::keyBackClicked");
