...
bool HudLayer::init()
{
    ...
    livesLabel = CCLabelBMFont::create(CCString::createWithFormat("%ld",
                              GameManager::sharedGameManager()->getLives())->getCString(), "myGlyphs.fnt");
    livesLabel->retain();
    ...
    //addChild(livesLabel, 10, kLabel_Lives);
...
//void HudLayer::updateLivesLabel(long aLives) {
//  CCLabelBMFont	*label	= (CCLabelBMFont*)getChildByTag(kLayer::HudLife);
//}
