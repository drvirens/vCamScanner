...
#ifndef __Viren_Jumping_Line_Man__MainMenuLayer__
#define __Viren_Jumping_Line_Man__MainMenuLayer__
...
#endif /* defined(__Viren_Jumping_Line_Man__MainMenuLayer__) */
