...
#ifndef __Viren_Jumping_Line_Man__GameManager__
#define __Viren_Jumping_Line_Man__GameManager__
...
//    CC_SYNTHESIZE(TestGroundScene *, gameplayLayer, TestGroundScene);
    CC_SYNTHESIZE(World *, gameplayLayer, World);
...
private:
  bool mSoundCheck;
  bool mSoundMediaLoaded;
//  long mCurrentScore;
};

#endif /* defined(__Viren_Jumping_Line_Man__GameManager__) */
