//
//  GameConfig.h
//  Viren_Jumping_Line_Man
//
//
//

#ifndef Viren_Jumping_Line_Man_GameConfig_h
#define Viren_Jumping_Line_Man_GameConfig_h

#include "cocos2d.h"

//score
#define kUnitScoreIncrease_KilledBlackWolf 100
